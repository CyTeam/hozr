class WorkQueueController < ApplicationController
  ...
  def admin
    ...
    @print_result_count = Cyto::Case.count(:all, :conditions => '(screened_at IS NOT NULL OR (screened_at IS NULL and needs_p16 = 1) AND needs_review = 0 ) AND result_report_printed_at IS NULL')
